...
def can_function(speed, idx):
  ...
  checksum = crc8_pedal(packer.make_can_msg("GAS_SENSOR", 0, {"COUNTER_PEDAL": idx&0xF}, idx)[2][:-1])
  values["CHECKSUM_PEDAL"] = checksum
  msg.append(packer.make_can_msg("GAS_SENSOR", 0, values, idx))
  ...
  # radar
  if idx%5 == 0:
    msg.append(rpacker.make_can_msg("RADAR_DIAGNOSTIC", 1, {"RADAR_STATE": 0x79}, idx//5))
    for i in range(16):
      msg.append(rpacker.make_can_msg("TRACK_%d" % i, 1, {}, idx//5))
